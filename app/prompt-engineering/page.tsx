...
export const metadata: Metadata = {
  ...
  description:
    "Master the art of prompt engineering with our comprehensive guides for ChatGPT, Midjourney, DALL-E, and other AI tools.",
  keywords:
    "prompt engineering, AI prompts, effective prompts, prompt techniques, prompt optimization",
};
